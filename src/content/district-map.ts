...
export const DISTRICT_BOUNDARIES: readonly DistrictBoundary[] = [
  {
    ...
    description:
      "Smíchov, Košíře, Motol, Radlice, Jinonice, Hlubočepy a Barrandov.",
    center: { x: 740, y: 175 },
  ...
  },
  {
    ...
    description:
      "Stodůlky, Lužiny, Nové Butovice, Hůrka, Velká Ohrada a Třebonice.",
    center: { x: 350, y: 260 },
...
export const DISTRICT_PINS: readonly DistrictPin[] = [
  ...
  },
  {
    ...
    description:
      "SSPŠG v Preslově ulici se pod vedením Radka Sáblíka stala jednou z nejinovativnějších škol v zemi. Součástí školy je startupový inkubátor Next Zone, studentská AI laboratoř, mediální dům i programy pro seniory. Právě zde vznikl nápad na studentskou kampaň do Senátu.",
  ...
  },
  {
    ...
    description:
      "Smíchov City představuje nejrozsáhlejší urbanistický projekt v centrální Praze. Vyroste zde bydlení pro tisíce lidí, nová centrála České spořitelny a moderní dopravní terminál. Klíčem k úspěchu je včasné vybudování občanské vybavenosti.",
  ...
  // Praha 5 - Košíře & Motol
  {
    ...
    description:
      "Košíře leží v sevřeném údolí Motolského potoka. Plzeňská ulice je klíčovou tramvajovou i automobilovou spojnicí, která však čtvrť rozděluje na dvě poloviny. Potřebuje zklidnění a kvalitnější veřejný prostor.",
  ...
  },
  {
    ...
    description:
      "Motol v sobě spojuje největší nemocniční komplex v republice s klidnými rezidenčními vilovými čtvrtěmi. Je to ukázkový příklad místa, kde se potkává celostátní infrastruktura s každodenními potřebami místních občanů.",
  ...
  // Praha 5 - Radlice & Jinonice
  {
    ...
    description:
      "Radlická radiála je chybějící spojkou mezi Městským okruhem na Zlíchově a Pražským okruhem na Třebonicích. Její odkládání dusí celou jižní část Prahy 5 tranzitní dopravou.",
  ...
  },
  {
    ...
    description:
      "Areál Waltrovky je příkladem úspěšné transformace průmyslového brownfieldu. V okolí však rapidně stoupl počet obyvatel, což vytváří tlak na veřejné služby a lékařskou péči.",
  ...
  // Praha 5 - Barrandov & Hlubočepy
  {
    ...
    description:
      "Hluboký vápencový kaňon je zelenými plícemi celého senátního obvodu. Tvoří přirozenou rekreační zónu pro obyvatele Smíchova, Jinonic, Barrandova i Stodůlek.",
  ...
  },
  {
    ...
    description:
      "Sídliště Barrandov má sice výborné tramvajové spojení na Smíchov a do centra, ale vnitřní sídlištní infrastruktura po čtyřiceti letech existence vyžaduje zásadní investice do parkování a služeb pro stárnoucí generaci.",
  ...
  // Praha 13 - Hůrka, Lužiny, Stodůlky, Velká Ohrada
  {
    ...
    description:
      "Sluneční náměstí je administrativním i společenským centrem městské části Praha 13. Radko Sáblík se zavázal, že zde bude pravidelně osobně k dispozici lidem pro řešení problémů se školami, úřady či legislativou.",
  ...
  },
  {
    ...
    description:
      "Centrální park Prahy 13 je mimořádně zdařilou rekreační osou jihozápadního města, která vede podél Prokopského potoka až k ústí do Prokopského údolí. Udržení jeho klidu a celistvosti je pro místní zásadní prioritou.",
  ...
  },
  {
    ...
    description:
      "Sídliště Velká Ohrada vzniklo na přelomu 80. a 90. let. Dnes zde žije přes 12 000 obyvatel. Nedostatek pediatrů je zde palčivým tématem pro desítky mladých rodin.",
  ...
  },
  {
    ...
    description:
      "Zličín je klíčovým multimodálním terminálem pro celou západní část Prahy a přilehlé okresy Praha-západ a Beroun. Bez dostatečných kapacit pro přestup na MHD trpí ulice celého obvodu.",
